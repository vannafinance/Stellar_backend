...
export const AnimatedTabs = ({
      ...
      >
        {tabs.map((tab) => {
          ...
          return (
            ...
            >
              <div
                className={`rounded-lg p-3 ${isDark ? "bg-[#111111] text-[#FFFFFF]" : "bg-white text-black"}`}
              >
                {tab.label}
              </div>
            </button>
  ...
  if (type === "underline") {
    return (
      <div
        className={`h-fit overflow-x-auto scrollbar-hide ${containerClassName}`}
      >
        <div
  ...
  const containerPadding =
    type === "solid" || type === "ghost" ? "p-[4px] w-fit h-fit" : "p-1";
  const containerWidth =
    type === "solid" || type === "ghost" ? "w-full" : "w-full";
  const tabWidth = customTabWidth
    ...
    : type === "solid"
      ...
      : type === "ghost"
        ...
        : "";
  const tabPadding =
    type === "solid" || type === "ghost" ? "py-[12px] px-[8px]" : "";
  const tabHeight =
    type === "solid" ? "h-fit" : type === "ghost" ? "h-[38px]" : "h-9";
    ...
    <div className={containerClassName}>
      ...
      >
        ...
        {type === "gradient" && (
          ...
          >
            <div
              className={`rounded-[12px] h-full w-full ${isDark ? "bg-[#111111]" : "bg-white"}`}
            />
          </motion.div>
        )}
