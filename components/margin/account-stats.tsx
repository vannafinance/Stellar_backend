...
export const AccountStats = ({
  ...
  return (
    <>
      ...
      <div className={`hidden sm:grid border-[1px] rounded-[16px] w-full h-auto overflow-hidden ${gridCols} ${calculatedGridRows} ${
        isDark
          ...
          return (
            ...
            >
              ...
              <div className="flex items-center gap-2">
                ...
                <span className={`text-[13px] font-medium leading-tight ${isDark ? "text-[#A0A0A0]" : "text-[#6B7280]"}`}>
                  {item.name}
                </span>
              </div>
              {/* Value */}
              <motion.div
                className={`text-[26px] font-bold leading-none pl-0.5 ${isDark ? "text-white" : "text-[#111111]"}`}
                initial={{ opacity: 0 }}
